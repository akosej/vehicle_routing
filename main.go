...
func main() {
	...
	for iteration := 1; iteration <= NumIterations; iteration++ { // Se inicia un ciclo for para iterar un número determinado de veces
		// Configurar el tipo de producto y la demanda de cada producto => Demand[]
		nodes := []models.Node{ // Se crea un slice de estructuras Node
			{Id: 0, Demand: []models.Demand{{Id: 1, Product: 1, Demand: 100}, {Id: 2, Product: 2, Demand: 200}}, ServiceTime: 30, Distance: []float64{0.00, 98.45, 36.92, 21.97, 80.18, 22.24, 99.45, 65.50, 50.97, 40.00, 41.00, 31.22, 28.44, 128.33, 142.66, 98.45, 49.23, 101.31, 77.10}},
			{Id: 1, Demand: []models.Demand{{Id: 1, Product: 1, Demand: 100}, {Id: 2, Product: 2, Demand: 200}}, ServiceTime: 30, Distance: []float64{98.45, 0.00, 128.82, 86.06, 177.07, 93.83, 197.41, 162.62, 141.58, 138.02, 124.61, 84.06, 106.46, 226.02, 240.30, 196.91, 49.23, 198.35, 174.11}},
			{Id: 2, Demand: []models.Demand{{Id: 1, Product: 1, Demand: 100}, {Id: 2, Product: 2, Demand: 200}}, ServiceTime: 30, Distance: []float64{36.92, 128.82, 0.00, 42.77, 66.69, 35.27, 79.92, 53.85, 14.06, 20.28, 13.26, 67.65, 57.27, 98.50, 112.52, 74.28, 80.97, 70.32, 63.68}},
			{Id: 3, Demand: []models.Demand{{Id: 1, Product: 1, Demand: 100}, {Id: 2, Product: 2, Demand: 200}}, ServiceTime: 30, Distance: []float64{21.97, 86.06, 42.77, 0.00, 98.99, 8.20, 116.69, 84.40, 55.64, 54.35, 39.63, 42.41, 48.58, 140.70, 154.87, 113.77, 39.00, 112.74, 95.85}},
			{Id: 4, Demand: []models.Demand{{Id: 1, Product: 1, Demand: 100}, {Id: 2, Product: 2, Demand: 200}}, ServiceTime: 30, Distance: []float64{80.18, 177.07, 66.69, 98.99, 0.00, 94.35, 22.24, 14.68, 65.57, 47.26, 79.56, 95.74, 73.47, 64.84, 77.67, 29.83, 128.33, 49.70, 3.15}},
			{Id: 5, Demand: []models.Demand{{Id: 1, Product: 1, Demand: 100}, {Id: 2, Product: 2, Demand: 200}}, ServiceTime: 30, Distance: []float64{22.24, 93.83, 35.27, 8.20, 94.35, 0.00, 111.20, 79.92, 47.76, 48.50, 31.45, 47.76, 50.49, 133.61, 147.71, 107.58, 47.17, 105.53, 91.21}},
			{Id: 6, Demand: []models.Demand{{Id: 1, Product: 1, Demand: 100}, {Id: 2, Product: 2, Demand: 200}}, ServiceTime: 30, Distance: []float64{99.45, 197.41, 79.92, 116.69, 22.24, 111.20, 0.00, 35.27, 75.12, 62.73, 91.69, 117.27, 95.27, 45.04, 56.77, 14.06, 148.35, 37.97, 24.56}},
			{Id: 7, Demand: []models.Demand{{Id: 1, Product: 1, Demand: 100}, {Id: 2, Product: 2, Demand: 200}}, ServiceTime: 30, Distance: []float64{65.50, 162.62, 53.85, 84.40, 14.68, 79.92, 35.27, 0.00, 54.73, 33.81, 66.99, 82.01, 60.14, 73.81, 87.45, 39.00, 113.77, 53.85, 11.60}},
			{Id: 8, Demand: []models.Demand{{Id: 1, Product: 1, Demand: 100}, {Id: 2, Product: 2, Demand: 200}}, ServiceTime: 30, Distance: []float64{50.97, 141.58, 14.06, 55.64, 65.57, 47.76, 75.12, 54.73, 0.00, 25.32, 18.50, 81.55, 69.96, 87.92, 101.62, 67.36, 94.33, 59.68, 62.80}},
			{Id: 9, Demand: []models.Demand{{Id: 1, Product: 1, Demand: 100}, {Id: 2, Product: 2, Demand: 200}}, ServiceTime: 30, Distance: []float64{40.00, 138.02, 20.28, 54.35, 47.26, 48.50, 62.73, 33.81, 25.32, 0.00, 33.54, 66.12, 49.73, 88.33, 102.66, 59.49, 88.89, 61.43, 44.16}},
			{Id: 10, Demand: []models.Demand{{Id: 1, Product: 1, Demand: 100}, {Id: 2, Product: 2, Demand: 200}}, ServiceTime: 30, Distance: []float64{41.00, 124.61, 13.26, 39.63, 79.56, 31.45, 91.69, 66.99, 18.50, 33.54, 0.00, 72.17, 65.50, 106.41, 120.08, 84.98, 78.62, 78.17, 76.58}},
			{Id: 11, Demand: []models.Demand{{Id: 1, Product: 1, Demand: 100}, {Id: 2, Product: 2, Demand: 200}}, ServiceTime: 30, Distance: []float64{31.22, 84.06, 67.65, 42.41, 95.74, 47.76, 117.27, 82.01, 81.55, 66.12, 72.17, 0.00, 22.67, 152.12, 166.39, 119.45, 39.99, 126.69, 93.00}},
			{Id: 12, Demand: []models.Demand{{Id: 1, Product: 1, Demand: 100}, {Id: 2, Product: 2, Demand: 200}}, ServiceTime: 30, Distance: []float64{28.44, 106.46, 57.27, 48.58, 73.47, 50.49, 95.27, 60.14, 69.96, 49.73, 65.50, 22.67, 0.00, 131.90, 146.02, 98.34, 60.39, 107.65, 70.83}},
			{Id: 13, Demand: []models.Demand{{Id: 1, Product: 1, Demand: 100}, {Id: 2, Product: 2, Demand: 200}}, ServiceTime: 30, Distance: []float64{128.33, 226.02, 98.50, 140.70, 64.84, 133.61, 45.04, 73.81, 87.92, 88.33, 106.41, 152.12, 131.90, 0.00, 14.35, 35.16, 177.07, 28.27, 66.12}},
			{Id: 14, Demand: []models.Demand{{Id: 1, Product: 1, Demand: 100}, {Id: 2, Product: 2, Demand: 200}}, ServiceTime: 30, Distance: []float64{142.66, 240.30, 112.52, 154.87, 77.67, 147.71, 56.77, 87.45, 101.62, 102.66, 120.08, 166.39, 146.02, 14.35, 0.00, 48.50, 191.38, 42.19, 79.18}},
			{Id: 15, Demand: []models.Demand{{Id: 1, Product: 1, Demand: 100}, {Id: 2, Product: 2, Demand: 200}}, ServiceTime: 30, Distance: []float64{98.45, 196.91, 74.28, 113.77, 29.83, 107.58, 14.06, 39.00, 67.36, 59.49, 84.98, 119.45, 98.34, 35.16, 48.50, 0.00, 147.68, 23.91, 30.97}},
			{Id: 16, Demand: []models.Demand{{Id: 1, Product: 1, Demand: 100}, {Id: 2, Product: 2, Demand: 200}}, ServiceTime: 30, Distance: []float64{49.23, 49.23, 80.97, 39.00, 128.33, 47.17, 148.35, 113.77, 94.33, 88.89, 78.62, 39.99, 60.39, 177.07, 191.38, 147.68, 0.00, 149.61, 125.33}},
			{Id: 17, Demand: []models.Demand{{Id: 1, Product: 1, Demand: 100}, {Id: 2, Product: 2, Demand: 200}}, ServiceTime: 30, Distance: []float64{101.31, 198.35, 70.32, 112.74, 49.70, 105.53, 37.97, 53.85, 59.68, 61.43, 78.17, 126.69, 107.65, 28.27, 42.19, 23.91, 149.61, 0.00, 49.73}},
			{Id: 18, Demand: []models.Demand{{Id: 1, Product: 1, Demand: 100}, {Id: 2, Product: 2, Demand: 200}}, ServiceTime: 30, Distance: []float64{77.10, 174.11, 63.68, 95.85, 3.15, 91.21, 24.56, 11.60, 62.80, 44.16, 76.58, 93.00, 70.83, 66.12, 79.18, 30.97, 125.33, 49.73, 0.00}},
		}
		NumNodes := 18
		ants := []models.Ant{ // Se crea un slice de estructuras Ant
			...
			{Id: 5, AverageSpeed: 50, Visited: make([]bool, NumNodes), CurrentNode: startNode, Route: []int{startNode}, Capacity: []models.Compartment{{Id: 1, Capacity: 100}}, RemainingCapacity: []models.Compartment{{Id: 1, Capacity: 100}}, FixedCost: 197.26, VariableCost: 22.72},
		}
		// ----------------------
		// if iteration == 1 {
		...
		for containsFalse {
			...
			for _, node := range remainingNodes { // Se itera sobre los nodos no visitados
				remainingVisited[node] = true //TODO Ver restriccionm. Se marca el nodo como visitado en remainingVisited
			}
